      ...
      <div class="col-lg-9">
        <div class="card shadow">
          ...
          <div class="card-body">
            ...
            <?php endif ?>
            <form id="careerForm" action="<?= base_url('registrarCarrera/registrar') ?>" method="POST">
              <?= csrf_field() ?>
                            ...
                            <tr>
                                ...
                                <td><?= esc($car['ncar']) ?></td>
                                 <td>
                                    ...
                                    <form action="<?= base_url('registrarCarrera/delete/' . $car['id_car']) ?>" method="POST" class="d-inline delete-form">
                                        <?= csrf_field() ?>
