...
<head>
    ...
    <title>Acceso Administradores - Instituto Superior</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet" />
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" />
    <link rel="stylesheet" href="<?= base_url('styles.css') ?>" />
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/sweetalert2@11/dist/sweetalert2.min.css" />
</head>
<body class="administradores-access-page">
    <?= view('templates/Navbar') ?>
    <header class="bg-warning text-white py-5">
        <div class="container text-center">
            <h1 class="display-4 fw-bold mb-4">Acceso Administradores</h1>
            <p class="lead">Ingresa tus credenciales para acceder al panel de administración</p>
        </div>
    </header>
            ...
            <div class="col-lg-6">
                <div class="card shadow">
                    <div class="card-header bg-warning text-white text-center">
                        <h2 class="h5 mb-0"><i class="fas fa-user-shield me-2"></i>Login Administradores</h2>
                    </div>
                    <div class="card-body">
                        ...
                        <?php endif ?>
                        <form id="loginForm" method="post" action="<?= base_url('administradores/login') ?>">
                            <?= csrf_field() ?>
                            <div class="mb-3">
